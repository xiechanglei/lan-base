...
public class LanRbacAuthCodeInitiation {

    private final LanSysAuthCodeRepository lanSysAuthCodeRepository;
    ...
    public void initData(ApplicationContext applicationContext) {
        ...
        DataUpdaterUtil.update(lanSysAuthCodeRepository, allAuthCode);
    }
