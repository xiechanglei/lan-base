 ...
 * 系统菜单
 */
@Menu(title = "系统管理", menuType = SysMenu.MenuType.FOLDER, code = "rbac:menu:system:manager", icon = "pro://lan.base.rbac.icon-sys-manager", order = 99)
public class InternalMenuSystemManager {

    @Menu(title = "用户管理", code = "rbac:menu:user:manager", icon = "pro://lan.base.rbac.icon-sys-manager-user", order = 1)
    ...
    @Menu(title = "菜单管理", code = "rbac:menu:menu:manager", icon = "pro://lan.base.rbac.icon_sys_manager_menu", order = 3)
