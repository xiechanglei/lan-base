...
public class LanBaseRbacDataInitiation {
    ...
    public void initData(ApplicationContext applicationContext) {
        // 更新权限数据
        log.info("更新权限数据...");
        lanBaseRbacAuthCodeInitiation.initData(applicationContext);
        // 更新菜单和功能数据
        List<String> allResourceIds = lanBaseRbacMenuAndFuncInitiation.initData(applicationContext);
        // 更新角色数据
        lanBaseRbacRoleInitiation.initData(allResourceIds);
    }
}
