 ...
 * 具体的配置参数参照{@link LanWebCrossConfigProperties}
 * </pre>
 * <p>
...
public class LanWebCrossOriginConfiguration implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping(lanWebCrossConfigProperties.getMapping())
                .allowedMethods(lanWebCrossConfigProperties.getMethods())
                .allowedOrigins(lanWebCrossConfigProperties.getOrigins())
                .allowedHeaders(lanWebCrossConfigProperties.getHeaders())
                .allowCredentials(lanWebCrossConfigProperties.isAllowCredentials())
                .maxAge(lanWebCrossConfigProperties.getMaxAge());
    }
}
