 ...
 * 具体的配置参数参照{@link LanBaseWebCrossConfigProperties}
 * </pre>
 * <p>
...
@ConditionalOnProperty(prefix = "lan.base.web.cross", name = "enable", havingValue = "true", matchIfMissing = true)
public class LanBaseWebCrossOriginConfiguration implements WebMvcConfigurer {
    /**
     * 获取用户自定义的跨域配置参数
     */
    private final LanBaseWebCrossConfigProperties lanBaseWebCrossConfigProperties;
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping(lanBaseWebCrossConfigProperties.getMapping())
                .allowedMethods(lanBaseWebCrossConfigProperties.getMethods())
                .allowedOrigins(lanBaseWebCrossConfigProperties.getOrigins())
                .allowedHeaders(lanBaseWebCrossConfigProperties.getHeaders())
                .allowCredentials(lanBaseWebCrossConfigProperties.isAllowCredentials())
                .maxAge(lanBaseWebCrossConfigProperties.getMaxAge());
    }
}
